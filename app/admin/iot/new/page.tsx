...
import { Plus, Trash2, Cpu, Settings } from 'lucide-react';
...
export default function NewDevicePage() {
  ...
  const handleThemeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    // Auto-populate sensors based on theme preset
    if (THEME_PRESETS[theme]) {
      setSensors([...THEME_PRESETS[theme]]);
    } else {
      setSensors([]);
    }
  };
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Register a new physical device and configure its sensors.</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
        <form action={createDevice} className="space-y-8">
          {/* Hidden Config Field */}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., EWS Station 01 - Merapi"
                />
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Selecting a theme will auto-populate recommended sensors.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
                {sensors.length === 0 ? (
                  <div className="text-center py-8 bg-slate-50 rounded-lg border border-dashed border-slate-300 text-slate-400 text-sm">
                    No sensors configured. <br/>Select a theme or add manually.
                  </div>
                ) : (
